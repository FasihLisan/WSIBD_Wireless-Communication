...
public class TreeApp {
    public static void main(String[] args) throws IOException{
        ...
        theTree.insert(50, "Fasih");
        theTree.insert(25, "Asep");
        theTree.insert(75, "Sukirman");
        theTree.insert(12, "Hakim");
        theTree.insert(37, "Sikan");
        theTree.insert(43, "Slamet");
        theTree.insert(30, "Jon");
        theTree.insert(33, "Bleret");
        theTree.insert(97, "Riyadi");
        theTree.insert(93, "Nabila");
        theTree.insert(97, "Liya");
